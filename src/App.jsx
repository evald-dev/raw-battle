...
3. Качество записи и сведение<span style='color:#da6a1b;'> не являются критериями оценки</span> (СЫРОЙ БАТЛ)<br><br>
...
Критерии оценки и концепт смотри здесь <a href='#' data-open-film='concept' style='color:#ce1919e0; text-decoration: underline;'>(ссылка)</a>.</br></br>

<span style='color:#da6a1b;'>Участники, дошедшие до 4-го раунда, получают возможность публиковать информацию о своих новых релизах в Telegram-сообществе батла.</span>`
              }} />
            )}
          />
...
0.49 - <span style='color:#da6a1b;'>не коммерческий проект,</span> который полностью существует благодаря энтузиазму организатора.<br>

Здесь <span style='color:#da6a1b;'>пока</span> нет инвесторов, рекламных бюджетов и большой команды. Организатор одновременно занимается дизайном, администрированием и финансированием проекта.<br><br>

Главная цель батла - <span style='color:#da6a1b;'>создание творческой площадки для развития участников и поддержка русскоязычного андеграунда</span> в Германии. Призовые являются приятным дополнением, но не основной причиной существования проекта.<br><br>
Если вы хотите поддержать батл или стать спонсором - свяжитесь с организатором.<br><br> 
Общий призовой фонд на данный момент - около 1000€ (может расти со временем)<br><br>
1 место - 350€<br>
2 место - 250€<br>
3 место - 150€<br><br>
...
const conceptContent = (
  <span dangerouslySetInnerHTML={{
    __html:
      `<h1 style="font-size:16px; font-weight:600;">Русскоязычная андеграунд-сцена в Германии пока маленькая. Именно поэтому есть возможность повлиять на то, как она будет звучать завтра</h1><br>
    Проект создан как площадка для <span style='color:#da6a1b;'>андеграунд-исполнителей.</span><br>
    Здесь можно пробовать новые идеи <span style='color:#da6a1b;'>не оглядываясь на качество звука, продакшен</span> и ожидания того, какой "должна" быть музыка.<br><br>
    ...
    Если тебе есть что показать - записывай и <span style='color:#da6a1b;'>отправляй трек на отбор.</span><br> Если хочешь быть зрителем и следить за батлом - <span style='color:#da6a1b;'>вступай в группу Telegram</span><br><br>
    Мы рады любым трекам и экспериментам.` 
  }} />
);
